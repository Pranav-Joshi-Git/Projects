			...
			<div class="container">
				...
				<div id="courses-wrapper" >
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://reactjs.org/tutorial/tutorial.html" target="_blank" class="course-img">
									<img src="./img/courserea.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://reactjs.org/tutorial/tutorial.html" target="_blank" style="font-size:18px; text-align: center">React Tutorial</a>
								<div class="course-details" style="margin:5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-free">Free</span>
								</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="https://www.w3schools.com/html/default.asp" target="_blank" style="font-size:18px; text-align: center">HTML & CSS</a>
								<div class="course-details" style="margin: 5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-premium">Premium</span>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="https://www.tutorialspoint.com/ruby/index.htm" target="_blank" style="font-size:18px; text-align: center">Ruby on Rails5</a>
								<div class="course-details" style="margin:5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-premium">Premium</span>
								</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.udemy.com/course/html-sass-javascript-create-responsive-portfolio-website/" target="_blank" class="course-img">
									<img src="./img/coursesass.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.udemy.com/course/html-sass-javascript-create-responsive-portfolio-website/" target="_blank" style="font-size:18px; text-align: center">Introduction to Sass</a>
								<div class="course-details" style="margin:5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-premium">Premium</span>
								</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.udemy.com/course/react-js-and-redux-mastering-web-apps/" target="_blank" class="course-img">
									<img src="./img/coursereact.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.udemy.com/course/react-js-and-redux-mastering-web-apps/" target="_blank" style="font-size:18px; text-align: center">React complete course</a>
								<div class="course-details" style="margin: 5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-premium">Premium</span>
								</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.udemy.com/course/javascript-advanced/" class="course-img" target="_blank">
									<img src="./img/coursejas.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.udemy.com/course/javascript-advanced/" target="_blank" style="font-size:18px; text-align: center">Complete guide on JavaScript</a>
								<div class="course-details" style="margin: 5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-premium">Premium</span>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.tutorialspoint.com/python/index.htm" class="course-img" target="_blank">
									<img src="./img/coursepy.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.tutorialspoint.com/python/index.htm" target="_blank" style="font-size:18px; text-align: center">Complete guide on python</a>
								<div class="course-details" style="margin: 5px;">
									<span class="course-category">Programming</span>
									<span class="course-price course-free">Free</span>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.coursera.org/learn/python" class="course-img" target="_blank">
									<img src="./img/coursepyth.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.coursera.org/learn/python" target="_blank" style="font-size:18px; text-align: center">Python Programming</a>
								<div class="course-details" style="margin: 5px;">
									<span class="course-category">Programming</span>
									<span class="course-price course-premium">Premium</span>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.tutorialspoint.com/php/index.htm" target="_blank" class="course-img">
									<img src="./img/course05.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.tutorialspoint.com/php/index.htm" target="_blank" style="font-size:18px; text-align: center"><b>PHP Tips, Tricks, and Techniques</b></a>
								<div class="course-details" style="margin: 5px;">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://nodejs.dev/learn/introduction-to-nodejs" target="_blank" class="course-img">
									<img src="./img/coursend.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://nodejs.dev/learn/introduction-to-nodejs" target="_blank" style="font-size:18px; text-align: center"><b>Node.js crash course</b></a>
								<div class="course-details" style="margin: 5px;">
									<span class="course-category">Server Side</span>
									<span class="course-price course-free">Free</span>
								</div>
