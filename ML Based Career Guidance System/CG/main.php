...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/image.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
						...
						<div class="col-md-8">
							...
							<?php
								...
								<?php else: ?>
									...
									<a class="main-button icon-button" href="http://localhost:5000/">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Guidance-Geek</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Guidance-Geek</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								<?php else: ?>
									<a href="http://localhost:5000/"><h4>Career Prediction</h4></a>
		...
		<div id="cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bg123.jpg)"></div>
			<!-- /Backgound Image -->
		...
		<div id="about" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="about-img">
							<img src="./img/contact-us-background.jpg" alt="">
						</div>
					</div>
		...
		<div id="contact-cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/contactus.jpg)"></div>
			<!-- Backgound Image -->
